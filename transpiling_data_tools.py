...
# Uncomment the following lines if you are experiencing errors AND want to live life dangerously
# reload(sys)
# sys.setdefaultencoding('UTF8')  # steamroll encoding errors... I live life dangerously.
